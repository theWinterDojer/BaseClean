              ...
              if (!connected) {
                return (
                  <button
                    ...
                    type="button"
                    className="px-4 py-2 bg-gradient-to-r from-green-600 to-green-500 hover:from-green-500 hover:to-green-400 text-white font-medium rounded-md shadow-sm transition-all hover:shadow-md flex items-center gap-2"
                  >
