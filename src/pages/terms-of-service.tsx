      ...
      <div className="min-h-screen bg-gray-950 text-white">
        <div className="max-w-4xl mx-auto py-12 px-6">
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4">3. User Responsibilities and Acknowledgments</h2>
              <div className="space-y-4">
                <p><strong>3.1 Sole Responsibility:</strong> You acknowledge and agree that you are solely and exclusively responsible for:</p>
                ...
                <p><strong>3.2 Technical Understanding:</strong> You represent that you understand:</p>
                <ul className="list-disc pl-6 space-y-2">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4">4. Disclaimers and Limitation of Liability</h2>
              <div className="space-y-4">
                <p><strong>4.1 Complete Disclaimer of Liability:</strong> TO THE MAXIMUM EXTENT PERMITTED BY LAW, BASECLEAN, ITS DEVELOPERS, OPERATORS, CONTRIBUTORS, AND AFFILIATED PARTIES DISCLAIM ALL LIABILITY FOR:</p>
                <ul className="list-disc pl-6 space-y-2">
                ...
                <p><strong>4.2 No Warranties:</strong> THE SERVICE IS PROVIDED &quot;AS IS&quot; AND &quot;AS AVAILABLE&quot; WITHOUT WARRANTIES OF ANY KIND, WHETHER EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO:</p>
                <ul className="list-disc pl-6 space-y-2">
                ...
                <p><strong>4.3 Maximum Liability Cap:</strong> In no event shall the total liability of BaseClean exceed $0.00 USD.</p>
              </div>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4">5. Release and Indemnification</h2>
              <p className="mb-4">
                <strong>5.1 General Release:</strong> You hereby release, waive, discharge, and covenant not to sue BaseClean, 
              ...
              <p className="mb-4">
                <strong>5.2 Indemnification:</strong> You agree to indemnify, defend, and hold harmless BaseClean and its 
